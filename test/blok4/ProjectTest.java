...
class ProjectTest {
    ...
    public void TestAlsNummerNietKloptVoorProject(){
        Project P1 = new Project("NS Spoorwegen engineering","Engenering",2000.000,39384, new Date(2021,12,12));
    ...
    public void SetNieuwProjectDatum(){
        Project P1 = new Project("NS Spoorwegen engineering","Engenering",2000.000,39384, new Date(2021,12,12));
        P1.SetNewProjectDatum(new Date(2022,1,4));
        assertEquals(new Date(2022,1,4),P1.getProjectdatum());
    }
